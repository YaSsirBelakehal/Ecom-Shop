...
const Product = () => {
  ...
  if (!product) {
    return (
      <section className="min-h-screen flex items-center justify-center text-white bg-linear-to-r
      from-indigo-900 via-purple-900 to-pink-900">
        <p className="text-2xl font-bold">Product not exist</p>
  ...
  const handleAddToCart = () => {
    ...
    alert(`${quantity} pieces of ${product.name} have been added to the cart!`)
  }
  return (
    <section className="min-h-screen bg-linear-to-r from-indigo-900 via-purple-900
    to-pink-900 text-white py-24 px-6 sm:px-10">
      
      <div className="max-w-6xl mx-auto bg-white/10 backdrop-blur-md rounded-3xl p-10 flex flex-col
      md:flex-row gap-10 shadow-2xl">
        ...
        <div>
          ...
          <div className="flex gap-4">
            {["S", "M", "L", "XL"].map((size)=>(
              ...
              ${selectedSize === size ? "bg-cyan-400 text-black scale-105" : ""}`}>
                {size}
