...
const Verify = () => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-linear-to-r from-indigo-900
    via-purple-900 to-pink-900 text-white px-6">
      ...
      <div className="text-center flex flex-col items-center">
        ...
        {status === "success" &&(
          <div className="flex flex-col items-center animate-pulse">
            ...
            <p className="text-gray-300 mt-2">You will now be taken to your orders...</p>
        ...
        {status === "error" &&(
          <div className="flex flex-col items-center animate-pulse">
            ...
            <p className="text-gray-300 mt-2">You will be redirected to the homepage,an error occurred during the inestigation...</p>
