...
const Login = () => {
  ...
  return (
    ...
    to-pink-900 text-white py-24 px-6 sm:px-10 flex items-center justify-center">
      ...
      <div className="relative z-10 max-w-md bg-white/10 backdrop-blur-md p-10 rounded-3xl shadow-2xl">
      ...
      <form onSubmit={onLogin} className="flex flex-col gap-6">
        ...
        <button type="submit" className="bg-linear-to-r from-indigo-500 via-purple-500 to-pink-500
      ...
      <p className="mt-6 text-center text-gray-300">
        ...
        <span onClick={()=> navigate("/signup")} className="text-cyan-400 font-semibold cursor-pointer
        hover:underline">
