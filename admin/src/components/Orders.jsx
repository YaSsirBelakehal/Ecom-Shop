...
const Orders = () => {
  ...
  return (
    <section className="relative w-full md:ml-64 min-h-screen
    bg-linear-to-r from-indigo-900 via-purple-900 to-pink-900 text-white py-24
    px-6 sm:px-10">
      {
        orders.length === 0 ? (
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {orders.map((order)=>{
              ...
              border-white/20 rounded-2xl p-4 flex flex-col justify-between shadow-lg
              hover:scale-105 transform transition-all duration-300 lg:w-[60%] md:w-[60%] md:ml-20 lg:ml-20">
